...
const Home = () => {
  ...
  const testimonials = [
    ...
    {
      name: "Dr. Monalisha Sharma",
      role: "Special Educator",
      content:
        "I have had the privilege of working with Ms. Smita, who is an exceptionally committed educator. Her ability to support students, collaborate with staff and handle responsibilities with patience and professionalism is commendable. She brings empathy, expertise and consistency to her role, making a meaningful impact on both students and colleagues. I wish her the very best in this exciting new journey and look forward to seeing her ideas come to life.",
      rating: 5,
    },
  ];
