        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
              Get special education support at our partnered school or online, and let's work together to create an inclusive learning environment!
            </p>
          </div>
        </div>
      </section>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">+91 87923 80978</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                answer: "We can begin initial assessment within 2 weeks of signing the partnership agreement. Full implementation typically takes 1-2 months depending on school size and individual needs."
              },
              {
                question: "What is the investment for parents / schools?",
                answer: "Our partnerships are customized based on needs and school size."
              },
              {
